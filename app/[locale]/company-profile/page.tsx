...
import CompanyProfilePDFDownload from "@/components/CompanyProfilePDFDownload";
      ...
      <div className="print:hidden bg-gray-100 p-4 flex justify-between items-center">
        <div>
          <h1 className="text-xl font-bold text-gray-800">
            {isHe ? "הורד פרופיל החברה" : "Download Company Profile"}
          </h1>
          <p className="text-sm text-gray-600">
            {isHe ? "לחץ להורד כ-PDF" : "Click to download as PDF"}
          </p>
        </div>
        <CompanyProfilePDFDownload locale={locale} />
      </div>

      <div className="w-full min-h-screen bg-white p-0 m-0">
        {/* A4 Size Container - 210mm x 297mm */}
        <div id="company-profile-content" className="mx-auto" style={{ width: "210mm", minHeight: "297mm" }}>
