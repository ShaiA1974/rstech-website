...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://www.rstech.co.il/${locale}/companies/jae`,
      languages: { en: "https://www.rstech.co.il/en/companies/jae", he: "https://www.rstech.co.il/he/companies/jae", "x-default": "https://www.rstech.co.il/en/companies/jae" },
    },
    openGraph: {
      ...
      url: `https://www.rstech.co.il/${locale}/companies/jae`,
      type: "website",
      images: [
        {
          url: "https://www.rstech.co.il/products/jae/jae-fi.jpg",
          width: 1200,
          height: 630,
