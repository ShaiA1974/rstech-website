...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "High Performance Aerospace Wire — Gore Products via RSTECH Electronics Israel",
    description:
...
export default async function Page({ params }: Props) {
  ...
  const imageUrl = "/products/gore/pwr-aerospace-wire.jpg";

  const product = {
    name: "High Performance Aerospace Wire",
    tagline: "Power Enabler — Aerospace Wiring",
    headline: "FAR 25.1359-Compliant Wiring That Cuts Weight Without Cutting Corners.",
    subheadline:
      "Gore High Performance Aerospace Wire combines ePTFE insulation's inherent flame resistance, chemical inertness, and low weight to meet the strictest civil and military wiring requirements. Approved for use on commercial airframes and military platforms, it delivers meaningful weight savings over conventional PTFE or polyimide-insulated wire — every gram matters at altitude.",
    description:
    ...
    benefits: [
      {
        title: "FAR 25.1359 Compliance",
        body: "Gore aerospace wire meets the flame propagation, arc-tracking resistance, and fluid compatibility requirements of FAR 25.1359, qualifying it for use in civil aircraft wiring systems. Compliance documentation is available to support aircraft certification programs.",
      },
      {
        title: "Significant Weight Savings",
        body: "ePTFE insulation is lighter than conventional PTFE or polyimide alternatives at equivalent dielectric performance. In a modern commercial aircraft with tens of kilometres of wiring, the weight reduction translates directly to payload capacity or fuel savings over the aircraft's service life.",
      },
      {
        title: "Fluid and Flame Resistance",
        body: "The wire passes hydraulic fluid immersion, fuel resistance, and flame propagation tests required for both civil and military aviation platforms. ePTFE does not absorb fluids or degrade when exposed to the full range of aviation maintenance chemicals.",
      },
    ],
    specs: [
      { label: "Compliance", value: "FAR 25.1359 (civil aircraft)" },
      { label: "Insulation", value: "ePTFE (expanded PTFE)" },
      { label: "Conductor", value: "Silver-plated copper or copper alloy" },
      { label: "Operating temperature", value: "−65°C to +200°C" },
      { label: "Flame resistance", value: "Passes FAR 25 flame propagation test" },
      { label: "Fluid resistance", value: "Hydraulic fluid, fuel, oil, de-icing fluid" },
    ],
    applications: [
      "Commercial aircraft primary and secondary power wiring",
      "Military aircraft avionics and power distribution",
      "Airframe wiring harness assemblies",
      "Engine bay and nacelle wiring (high-temperature zones)",
      "Helicopter and rotorcraft wiring systems",
      "UAV and unmanned platform power wiring",
    ],
    faq: [
      {
        q: "What makes ePTFE insulation better than conventional PTFE for aerospace wiring?",
        a: "Expanded PTFE (ePTFE) is lighter and more flexible than solid PTFE while retaining the same flame resistance, chemical inertness, and dielectric properties. The weight advantage is meaningful at scale in large aircraft harnesses.",
      },
      {
        q: "Is this wire qualified for military aircraft platforms?",
        a: "Gore aerospace wire has been used on both civil and military platforms. Specific qualification status depends on the platform and program. Contact RSTECH Electronics to discuss qualification documentation for your application.",
      },
      {
        q: "Does this wire support arc-tracking resistance requirements?",
        a: "Yes. FAR 25.1359 compliance includes arc-tracking resistance testing. Gore's ePTFE insulation does not sustain arcing along its surface, which is a critical safety property in densely packed aircraft wire bundles.",
      },
      {
        q: "Can RSTECH Electronics supply cut-to-length wire for harness assembly?",
        a: "Contact RSTECH Electronics to discuss supply format, reel sizes, and whether cut-to-length or assembled harness options are available for your program.",
      },
    ],
  };
