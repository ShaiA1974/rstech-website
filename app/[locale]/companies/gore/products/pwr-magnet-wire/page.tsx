...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Magnet Wire — Gore Products via RSTECH Electronics Israel",
    description:
...
export default async function Page({ params }: Props) {
  ...
  const imageUrl = "/products/gore/pwr-magnet-wire.jpg";

  const product = {
    name: "Magnet Wire",
    tagline: "Power Enabler — Winding Wire",
    headline: "More Compact Motors. Better Thermal Performance. Extreme Environments.",
    subheadline:
    ...
    benefits: [
      {
        title: "Thinner Insulation Wall, Higher Slot Fill",
        body: "Gore ePTFE insulation achieves the required dielectric strength at a thinner wall than conventional polyimide or enamel insulation. This allows more copper to fit in the motor slot, directly improving motor efficiency, torque density, and power output without increasing frame size.",
      },
      {
        title: "Rated for Extreme Operating Temperatures",
        body: "ePTFE maintains its insulation integrity from −65°C to +200°C continuously, making Gore magnet wire suitable for traction motors, aerospace actuators, and oil and gas submersible pumps where thermal limits are routinely approached.",
      },
      {
        title: "Chemical and Fluid Resistance",
        body: "Unlike enamel-insulated wire, Gore magnet wire is unaffected by exposure to hydraulic fluids, lubricating oils, fuels, and industrial solvents. This eliminates insulation degradation in motors operating in chemically aggressive environments.",
      },
    ],
    specs: [
      { label: "Insulation", value: "ePTFE (expanded PTFE)" },
      { label: "Operating temperature", value: "−65°C to +200°C" },
      { label: "Dielectric strength", value: "High — thin wall achievable" },
      { label: "Conductor", value: "Copper or copper alloy" },
      { label: "Chemical resistance", value: "Oils, fuels, hydraulic fluids, solvents" },
      { label: "Available gauges", value: "Application-specific (contact RSTECH)" },
    ],
    applications: [
    ...
    faq: [
      {
        q: "How does Gore magnet wire compare to polyimide-insulated (e.g., Kapton) magnet wire?",
        a: "Gore ePTFE insulation matches or exceeds polyimide in dielectric strength while offering superior chemical resistance and a lower dielectric constant. ePTFE is also inherently non-absorbing of moisture, which is a limitation of polyimide in humid environments.",
      },
      {
        q: "Can Gore magnet wire be wound on standard winding equipment?",
        a: "ePTFE-insulated wire requires attention to tension control during winding as ePTFE is softer than enamel insulation. Contact RSTECH Electronics to discuss winding recommendations and available technical support from Gore.",
      },
      {
        q: "Is this wire suitable for use in vacuum impregnation (VPI) processes?",
        a: "Gore magnet wire is compatible with vacuum pressure impregnation processes commonly used in motor manufacturing. ePTFE's chemical inertness ensures compatibility with common VPI resins.",
      },
      {
        q: "What is the maximum continuous operating temperature?",
        a: "Gore ePTFE-insulated magnet wire is rated for continuous operation at up to +200°C. Short-term excursions above this temperature are application-dependent — contact RSTECH Electronics for guidance.",
      },
    ],
  };
