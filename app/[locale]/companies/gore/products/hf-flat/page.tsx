...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "High Flex Flat Cables — Gore Products via RSTECH Electronics Israel",
    description:
...
export default async function Page({ params }: Props) {
  ...
  const imageUrl = "/products/gore/hf-flat.jpg";

  const product = {
    name: "High Flex Flat Cables",
    tagline: "High Flex & Automation Cables",
    headline: "Millions of Flex Cycles. Zero Compromise on Signal Integrity.",
    subheadline:
      "Gore High Flex Flat Cables are purpose-built for continuous, high-speed dynamic movement in robotic arms, pick-and-place systems, and semiconductor handling equipment. Their ePTFE insulation and fine-strand conductors maintain stable electrical performance across the full rated flex life.",
    description:
    ...
    benefits: [
      {
        title: "Validated Flex Life",
        body: "Gore flat cables are tested to millions of flex cycles without degradation in electrical performance or mechanical integrity. This dramatically reduces unplanned downtime and cable replacement costs in 24/7 automation lines.",
      },
      {
        title: "Slim Profile for Tight Routing",
        body: "The flat ribbon geometry allows routing through narrow cable chains, slots, and linear guide systems where round cables cannot fit. The low profile also reduces the moving mass on lightweight robotic axes.",
      },
      {
        title: "Stable Electrical Performance",
        body: "ePTFE insulation maintains consistent impedance and capacitance throughout the cable's flex life, ensuring sensor signals and encoder feedback remain accurate even after years of continuous movement.",
      },
    ],
    specs: [
      { label: "Construction", value: "Flat ribbon, multi-conductor" },
      { label: "Insulation", value: "ePTFE (expanded PTFE)" },
      { label: "Conductor material", value: "Stranded copper alloy" },
      { label: "Operating temperature", value: "−65°C to +200°C" },
      { label: "Flex life", value: "Millions of cycles (application-dependent)" },
      { label: "Typical applications", value: "Robotic axes, linear stages, pick-and-place" },
    ],
    applications: [
      "Industrial robot arm cabling (axes 1–6)",
      "Semiconductor wafer handling and inspection equipment",
      "Pick-and-place surface mount technology (SMT) machines",
      "Medical imaging gantry and scanning assemblies",
      "Linear motor and servo drive encoder feedback lines",
    ],
    faq: [
      {
        q: "How does Gore's flex life compare to standard automation flat cables?",
        a: "Gore flat cables are engineered specifically for dynamic flex applications and typically outperform standard PVC or PUR flat cables by several multiples in rated flex cycles, which translates to fewer cable replacements and less maintenance downtime.",
      },
      {
        q: "Can these cables be used in clean-room semiconductor environments?",
        a: "Yes. The ePTFE insulation has very low outgassing and particle generation, making it suitable for semiconductor fab environments that require strict contamination control.",
      },
      {
        q: "Are custom lengths and conductor counts available?",
        a: "Gore offers a range of conductor counts and pitches. Contact RSTECH Electronics to discuss your specific configuration requirements.",
      },
      {
        q: "What is the lead time for these cables in Israel?",
        a: "RSTECH Electronics maintains direct contact with Gore's supply chain. Lead times depend on configuration and stock levels — contact us for a current availability estimate.",
      },
    ],
  };
