...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Trackless Cables — Gore Products via RSTECH Electronics Israel",
    description:
...
export default async function Page({ params }: Props) {
  ...
  const imageUrl = "/products/gore/hf-trackless.jpg";

  const product = {
    name: "Trackless Cables",
    tagline: "High Flex & Automation Cables",
    headline: "Eliminate the Cable Carrier. Keep the Reliability.",
    subheadline:
      "Gore Trackless Cables are engineered for linear motion stages, gantry systems, and direct-drive platforms where cable carriers add weight, require maintenance, and limit travel speed. Their unique construction allows the cable to follow linear motion without a carrier while sustaining the flex durability demanded by high-cycle semiconductor and industrial automation.",
    description:
    ...
    benefits: [
      {
        title: "No Cable Carrier Required",
        body: "By eliminating the cable carrier (e-chain / cable track), system designers save installation space, reduce moving mass, and remove a key maintenance item. This is particularly valuable in high-speed semiconductor wafer transport and gantry-style inspection systems.",
      },
      {
        title: "High-Speed Linear Motion Compatibility",
        body: "Trackless cables are designed to handle the acceleration forces and rapid direction changes of high-speed linear stages without developing permanent set or fatigue-induced failures. They maintain their routed shape without a carrier to guide them.",
      },
      {
        title: "Long Service Life in High-Cycle Applications",
        body: "With ePTFE insulation and finely stranded conductors, Gore Trackless Cables sustain millions of linear travel cycles. This extended service life reduces cable replacement frequency and its associated downtime costs in 24/7 semiconductor fabrication environments.",
      },
    ],
    specs: [
      { label: "Motion type", value: "Linear (trackless — no e-chain required)" },
      { label: "Insulation", value: "ePTFE (expanded PTFE)" },
      { label: "Conductor", value: "Finely stranded copper alloy" },
      { label: "Operating temperature", value: "−65°C to +200°C" },
      { label: "Cleanliness", value: "Low outgassing / low particle generation" },
      { label: "Key industries", value: "Semiconductor, Industrial Automation" },
    ],
    applications: [
      "Semiconductor wafer handling and transport stages",
      "Linear motor-driven gantry inspection systems",
      "Flat panel display (FPD) manufacturing equipment",
      "PCB drilling and routing machine axes",
      "High-speed pick-and-place linear axes",
      "Precision metrology and scanning platforms",
    ],
    faq: [
      {
        q: "How does a trackless cable manage without an e-chain?",
        a: "Gore Trackless Cables are constructed to self-support their shape and absorb the bending stress of linear travel within the cable itself, distributing strain uniformly along the moving length. The cable's stiffness profile is tuned so it doesn't sag, whip, or tangle at rated speeds.",
      },
      {
        q: "What is the maximum travel speed these cables support?",
        a: "Maximum travel speed is application-specific and depends on the cable run length, stroke, and acceleration profile. Contact RSTECH Electronics with your motion parameters for a suitability assessment.",
      },
      {
        q: "Are these cables compatible with semiconductor clean-room environments?",
        a: "Yes. The ePTFE insulation has low outgassing and generates minimal particulate, meeting the contamination requirements of semiconductor fab environments.",
      },
      {
        q: "How do I specify the right trackless cable for my stage?",
        a: "Key parameters include stroke length, travel speed, acceleration, bend radius, and conductor requirements. RSTECH Electronics can work with Gore's engineering team to match the right product to your motion profile.",
      },
    ],
  };
