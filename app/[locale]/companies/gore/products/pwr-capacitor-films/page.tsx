...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Capacitor Films — Gore Products via RSTECH Electronics Israel",
    description:
...
export default async function Page({ params }: Props) {
  ...
  const imageUrl = "/products/gore/pwr-capacitor-films.jpg";

  const product = {
    name: "Capacitor Films",
    tagline: "Power Enabler Materials",
    headline: "Miniaturize Power Capacitors Without Sacrificing Dielectric Performance.",
    subheadline:
      "Gore ePTFE capacitor films enable designers to build smaller, lighter capacitors for power electronics while maintaining the superior dielectric strength, low loss tangent, and thermal stability that demanding aerospace, defense, and industrial applications require. Thinner dielectric layers translate directly into higher energy density per unit volume.",
    description:
    ...
    benefits: [
      {
        ...
        body: "ePTFE's low dielectric constant and high dielectric strength allow thinner film layers, enabling significantly higher capacitance per unit volume compared to conventional polymer films. This is critical for weight-constrained aerospace power electronics and compact industrial inverters.",
      },
      {
        title: "Exceptional Thermal Stability",
        body: "Gore capacitor films maintain their dielectric properties from cryogenic temperatures up to +200°C, making them suitable for underhood automotive, aerospace avionics bays, and high-power industrial drives that see wide temperature excursions.",
      },
      {
        title: "Low Dielectric Loss",
        body: "The very low loss tangent (tan δ) of ePTFE reduces self-heating in high-frequency AC applications such as power factor correction circuits, motor drives, and RF power amplifiers, extending capacitor operating life and improving system efficiency.",
      },
    ],
    specs: [
      { label: "Dielectric material", value: "ePTFE (expanded PTFE)" },
      { label: "Dielectric constant (εr)", value: "~1.3–1.5" },
      { label: "Loss tangent (tan δ)", value: "< 0.0002 at 1 MHz" },
      { label: "Dielectric strength", value: "High (application-dependent thickness)" },
      { label: "Operating temperature", value: "−65°C to +200°C" },
      { label: "Chemical resistance", value: "Inert to most solvents and electrolytes" },
    ],
    applications: [
      "High-voltage power electronics capacitors for inverters and converters",
      "Aerospace avionics power supply energy storage",
      "Motor drive power factor correction capacitors",
      "Pulse power and energy storage systems",
      "High-frequency RF power amplifier coupling capacitors",
      "Defense electronics compact power conditioning",
    ],
    faq: [
      {
        q: "What thicknesses of capacitor film are available?",
        a: "Gore ePTFE capacitor films are available in a range of thicknesses to match specific voltage rating, capacitance density, and frequency requirements. Contact RSTECH Electronics to discuss your design parameters.",
      },
      {
        q: "How do Gore capacitor films compare to polypropylene (PP) or polyester (PET) films?",
        a: "Gore ePTFE films offer a lower dielectric constant, lower loss tangent, and higher maximum operating temperature than polypropylene or polyester films. This translates to higher frequency performance, less self-heating, and suitability for extreme temperature environments where PP and PET cannot be used.",
      },
      {
        q: "Can these films be supplied in custom widths and lengths for winding?",
        a: "Yes. Gore capacitor films can be supplied in slit rolls suitable for winding into film capacitor elements. Contact RSTECH Electronics to discuss supply format requirements.",
      },
      {
        q: "Are Gore capacitor films RoHS and REACH compliant?",
        a: "Gore's ePTFE materials are generally compliant with major environmental regulations. Confirm specific compliance documentation with RSTECH Electronics for your application.",
      },
    ],
  };
