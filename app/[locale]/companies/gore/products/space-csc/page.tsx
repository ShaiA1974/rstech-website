...
export default async function Page({ params }: Props) {
  ...
  const imageUrl = "/products/gore/space-csc.jpg";

  const product = {
    name: "CSC Space Cables",
    tagline: "Lightweight Coaxial Cables for Satellite RF Distribution",
    headline: "CSC Space Cables: Phase-Stable RF Routing for Orbital Systems",
    subheadline: "Gore CSC-series lightweight coaxial space cables deliver excellent phase stability and radiation tolerance for satellite RF signal distribution, combining the electrical performance of precision coaxial cable with the mass efficiency demanded by spacecraft harness designers.",
    description: "CSC-series lightweight coaxial space cables with excellent phase stability and radiation tolerance for satellite RF signal distribution systems. Designed for on-board RF routing between antenna feeds, transponders, amplifiers, and signal processing units in communications and Earth observation satellites.",
    industries: ["Space", "Aerospace & Defense"],
    goreUrl: "https://www.gore.com/products/space-cables-type-csc",
    benefits: [
      {
        title: "Phase Stability Across Thermal Extremes",
        body: "Satellite RF distribution systems must maintain calibrated phase relationships between antenna elements and signal processing hardware throughout the thermal excursions of each orbit. CSC cables' ePTFE dielectric minimizes phase change with temperature, preserving the phase relationships that beamforming and signal coherence depend on — without requiring thermal compensation in system design.",
      },
      {
        title: "Mass-Efficient Coaxial Construction",
        body: "CSC cables achieve low-loss coaxial performance in a lighter package than conventional semi-rigid or flexible coaxial alternatives. For geostationary communication satellites where harness mass directly constrains payload capacity, and for small satellite constellations with strict bus mass budgets, CSC's mass efficiency translates directly to mission value.",
      },
      {
        title: "Radiation Tolerance for Full Mission Lifetime",
        body: "Radiation-induced degradation of cable dielectrics manifests as increased attenuation and impedance shift — errors that accumulate and degrade link margins over time. CSC cables' radiation-tolerant construction maintains stable insertion loss and impedance throughout the design radiation dose for LEO and GEO missions, supporting 15+ year satellite lifetimes.",
      },
    ],
    specs: [
      { label: "Cable Type", value: "Flexible coaxial, space-grade" },
      ...
      { label: "Shield Coverage", value: ">90% braid coverage" },
    ],
    applications: [
      "Satellite transponder internal RF distribution harness",
      "Active antenna unit (AAU) beam-forming network cabling",
      "Earth observation SAR and optical instrument RF feeds",
      "Navigation payload signal routing (GPS/GNSS payloads)",
      "Inter-unit coaxial jumpers between satellite modules",
      "Low-noise amplifier (LNA) to receiver chain interconnects",
    ],
    faq: [
      {
        q: "What frequency range does the CSC series support?",
        a: "CSC space cables are designed for RF signal distribution from DC to 40 GHz, covering the key satellite communication bands including L, S, C, X, Ku, and Ka. For higher frequency applications, contact RSTECH to discuss Gore's extended-frequency space cable options.",
      },
      {
        q: "How is CSC different from the ASW series?",
        a: "CSC is a coaxial cable designed for RF signal routing with controlled impedance (50 Ω) and defined shielding. ASW cables are wire/multi-conductor cables for general signal and data transmission without the coaxial RF structure. The choice depends on whether the application is an RF signal path or a digital/power signal route.",
      },
      {
        q: "Can CSC cables be supplied with space-grade SMA or SMP connectors?",
        a: "Yes. RSTECH Electronics can source CSC cable assemblies terminated with space-qualified connectors including SMA, SMP, MMCX, and custom space-heritage connector interfaces. Full material traceability documentation is available for flight assemblies.",
      },
      {
        q: "What is the minimum bend radius for CSC cables in spacecraft harness routing?",
        a: "Minimum bend radius for CSC cables depends on the specific cable diameter variant. Gore provides harness routing guidelines with each product. RSTECH's technical team can support harness design review to ensure routing complies with Gore's installation recommendations.",
      },
    ],
  };
