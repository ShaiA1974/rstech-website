...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://www.rstech.co.il/${locale}/companies/tsubaki/products/cab-bus`,
      languages: {
        en: `https://www.rstech.co.il/en/companies/tsubaki/products/cab-bus`,
        he: `https://www.rstech.co.il/he/companies/tsubaki/products/cab-bus`,
        "x-default": `https://www.rstech.co.il/en/companies/tsubaki/products/cab-bus`,
      },
    },
  };
}
