...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://rstech.co.il/${locale}/companies/tsubaki/products/cab-bus`,
      languages: {
        en: `https://rstech.co.il/en/companies/tsubaki/products/cab-bus`,
        he: `https://rstech.co.il/he/companies/tsubaki/products/cab-bus`,
        "x-default": `https://rstech.co.il/en/companies/tsubaki/products/cab-bus`,
      },
    },
  };
}
