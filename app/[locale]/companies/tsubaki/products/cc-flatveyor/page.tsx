...
const PRODUCT_ID = "cc-flatveyor";
const IMAGE_URL: string | null = "/products/tsubaki/cc-flatveyor.jpg";
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://www.rstech.co.il/${locale}/companies/tsubaki/products/cc-flatveyor`,
      languages: {
        en: `https://www.rstech.co.il/en/companies/tsubaki/products/cc-flatveyor`,
        he: `https://www.rstech.co.il/he/companies/tsubaki/products/cc-flatveyor`,
        "x-default": `https://www.rstech.co.il/en/companies/tsubaki/products/cc-flatveyor`,
      },
    },
  };
}
