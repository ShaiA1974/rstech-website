...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://rstech.co.il/${locale}/companies/tsubaki/products/cab-data`,
      languages: {
        en: `https://rstech.co.il/en/companies/tsubaki/products/cab-data`,
        he: `https://rstech.co.il/he/companies/tsubaki/products/cab-data`,
        "x-default": `https://rstech.co.il/en/companies/tsubaki/products/cab-data`,
      },
    },
  };
}
