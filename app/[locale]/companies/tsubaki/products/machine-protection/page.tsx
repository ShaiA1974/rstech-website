...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://rstech.co.il/${locale}/companies/tsubaki/products/machine-protection`,
      languages: {
        en: `https://rstech.co.il/en/companies/tsubaki/products/machine-protection`,
        he: `https://rstech.co.il/he/companies/tsubaki/products/machine-protection`,
        "x-default": `https://rstech.co.il/en/companies/tsubaki/products/machine-protection`,
      },
    },
  };
}
