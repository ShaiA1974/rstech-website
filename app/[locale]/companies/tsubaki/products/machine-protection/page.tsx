...
import { ArrowLeft, ExternalLink, ShieldCheck, ArrowRight, CheckCircle2, Download, Wrench } from "lucide-react";
...
const PRODUCT_ID = "machine-protection";
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://www.rstech.co.il/${locale}/companies/tsubaki/products/machine-protection`,
      languages: {
        en: `https://www.rstech.co.il/en/companies/tsubaki/products/machine-protection`,
        he: `https://www.rstech.co.il/he/companies/tsubaki/products/machine-protection`,
        "x-default": `https://www.rstech.co.il/en/companies/tsubaki/products/machine-protection`,
      },
    },
  };
}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="rounded-2xl overflow-hidden h-64 lg:h-80 bg-gradient-to-br from-slate-100 to-slate-50 flex items-center justify-center">
                {IMAGE_URL ? (
                  ...
                  <Wrench className="w-24 h-24 text-slate-400 opacity-40" />
                )}
              </div>
            </div>
          </div>
