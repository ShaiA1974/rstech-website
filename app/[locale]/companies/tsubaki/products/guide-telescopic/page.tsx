...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://rstech.co.il/${locale}/companies/tsubaki/products/guide-telescopic`,
      languages: {
        en: `https://rstech.co.il/en/companies/tsubaki/products/guide-telescopic`,
        he: `https://rstech.co.il/he/companies/tsubaki/products/guide-telescopic`,
        "x-default": `https://rstech.co.il/en/companies/tsubaki/products/guide-telescopic`,
      },
    },
  };
}
