...
const PRODUCT_ID = "guide-telescopic";
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://www.rstech.co.il/${locale}/companies/tsubaki/products/guide-telescopic`,
      languages: {
        en: `https://www.rstech.co.il/en/companies/tsubaki/products/guide-telescopic`,
        he: `https://www.rstech.co.il/he/companies/tsubaki/products/guide-telescopic`,
        "x-default": `https://www.rstech.co.il/en/companies/tsubaki/products/guide-telescopic`,
      },
    },
  };
}
