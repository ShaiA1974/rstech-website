...
const PRODUCT_ID = "cc-cleanveyor";
const IMAGE_URL: string | null = "/products/tsubaki/cc-cleanveyor.jpg";
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://www.rstech.co.il/${locale}/companies/tsubaki/products/cc-cleanveyor`,
      languages: {
        en: `https://www.rstech.co.il/en/companies/tsubaki/products/cc-cleanveyor`,
        he: `https://www.rstech.co.il/he/companies/tsubaki/products/cc-cleanveyor`,
        "x-default": `https://www.rstech.co.il/en/companies/tsubaki/products/cc-cleanveyor`,
      },
    },
  };
}
