...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://rstech.co.il/${locale}/companies/tsubaki/products/${productId}`,
      languages: {
        en: `https://rstech.co.il/en/companies/tsubaki/products/${productId}`,
        he: `https://rstech.co.il/he/companies/tsubaki/products/${productId}`,
        "x-default": `https://rstech.co.il/en/companies/tsubaki/products/${productId}`,
      },
    },
  };
}
