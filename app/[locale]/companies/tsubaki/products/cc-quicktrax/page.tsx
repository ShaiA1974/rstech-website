...
const PRODUCT_ID = "cc-quicktrax";
const IMAGE_URL: string | null = "/products/tsubaki/cc-quicktrax.jpg";
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://www.rstech.co.il/${locale}/companies/tsubaki/products/cc-quicktrax`,
      languages: {
        en: `https://www.rstech.co.il/en/companies/tsubaki/products/cc-quicktrax`,
        he: `https://www.rstech.co.il/he/companies/tsubaki/products/cc-quicktrax`,
        "x-default": `https://www.rstech.co.il/en/companies/tsubaki/products/cc-quicktrax`,
      },
    },
  };
}
