...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://rstech.co.il/${locale}/companies/tsubaki/products/cc-quicktrax`,
      languages: {
        en: `https://rstech.co.il/en/companies/tsubaki/products/cc-quicktrax`,
        he: `https://rstech.co.il/he/companies/tsubaki/products/cc-quicktrax`,
        "x-default": `https://rstech.co.il/en/companies/tsubaki/products/cc-quicktrax`,
      },
    },
  };
}
