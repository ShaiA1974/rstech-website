...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://rstech.co.il/${locale}/companies/tsubaki/products/cab-hv`,
      languages: {
        en: `https://rstech.co.il/en/companies/tsubaki/products/cab-hv`,
        he: `https://rstech.co.il/he/companies/tsubaki/products/cab-hv`,
        "x-default": `https://rstech.co.il/en/companies/tsubaki/products/cab-hv`,
      },
    },
  };
}
