...
import { ArrowLeft, ExternalLink, ShieldCheck, ArrowRight, CheckCircle2, Download, Cable } from "lucide-react";
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://www.rstech.co.il/${locale}/companies/tsubaki/products/cab-coaxial`,
      languages: {
        en: `https://www.rstech.co.il/en/companies/tsubaki/products/cab-coaxial`,
        he: `https://www.rstech.co.il/he/companies/tsubaki/products/cab-coaxial`,
        "x-default": `https://www.rstech.co.il/en/companies/tsubaki/products/cab-coaxial`,
      },
    },
  };
}
        ...
        <div className="relative bg-[#0F172A] overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="rounded-2xl overflow-hidden h-64 lg:h-80 bg-gradient-to-br from-amber-100 to-amber-50 flex items-center justify-center">
                {IMAGE_URL ? (
                  <Image src={IMAGE_URL} alt={product.name} width={600} height={400} className="w-full h-full object-cover" />
                ) : (
                  <Cable className="w-24 h-24 text-amber-500 opacity-40" />
                )}
              </div>
            </div>
          </div>
